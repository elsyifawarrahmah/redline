<?php
// Script untuk update config/koneksi.php secara otomatis
// Jalankan ini di browser: http://192.168.6.10/update_config.php
...
if (file_put_contents($configPath, $newConfig) !== false) {
    ...
    echo "Gagal update file. Cek permission folder config/";
}
?>