...
try {
    $stmt = $conn->query("SELECT * FROM speed_logs ORDER BY created_at DESC LIMIT 50");
...
// Hitung statistik
$totalPelanggaran = count($violations);
$pelanggaranHariIni = 0;
$kecepatanTertinggi = 0;

foreach ($violations as $v) {
    if (date('Y-m-d', strtotime($v['created_at'])) == date('Y-m-d')) {
        $pelanggaranHariIni++;
    }
    if (($v['speed'] ?? 0) > $kecepatanTertinggi) {
        $kecepatanTertinggi = $v['speed'];
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Pelanggaran - REDLINE Smart Speed Monitor</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-status.warning { background: rgba(234,179,8,0.15); color: #eab308; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="pelanggaran.php" class="sidebar-link active"><i class="fas fa-gavel"></i><span>Pelanggaran</span></a>
...
<main class="main-content" id="mainContent">
    <div class="topbar">
        <div class="page-title">🚨 DATA PELANGGARAN</div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo $totalPelanggaran; ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo $pelanggaranHariIni; ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo $kecepatanTertinggi; ?></div>
                <div class="stat-label">Kecepatan Tertinggi (km/h)</div>
            </div>
        </div>
    </div>
    ...
    <div class="card-glass">
        <div class="card-header">
            <span><i class="fas fa-list"></i> Daftar Pelanggaran</span>
                ...
                <tbody>
                    <?php if (count($violations) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-danger fw-bold"><?php echo htmlspecialchars($v['speed'] ?? 0); ?> km/h</td>
                            <td>60 km/h</td>
                            <td>
                                <?php if (($v['speed'] ?? 0) > 60): ?>
                                <span class="badge-status danger">MELANGGAR</span>
                                <?php else: ?>
                                <span class="badge-status warning">NORMAL</span>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <i class="fas fa-inbox fa-2x mb-3" style="color: rgba(255,255,255,0.3);"></i>
                                <p class="text-white-50">Belum ada data pelanggaran</p>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
